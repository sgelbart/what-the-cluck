...
class ChickensControllerTest < ActionController::TestCase
  ...
  test "should create chicken" do
    assert_difference('Chicken.count') do
      post :create, chicken: { description: @chicken.description, hatch_id: @chicken.hatch_id, name: @chicken.name }
    end
  ...
  test "should update chicken" do
    patch :update, id: @chicken, chicken: { description: @chicken.description, hatch_id: @chicken.hatch_id, name: @chicken.name }
    assert_redirected_to chicken_path(assigns(:chicken))
  end
